...
- UI direction: native system window, dark editorial library, fixed bottom player, persistent independent volume.

## User Priorities

- A visible, reliable way to close or quit the app.
- User-selectable close-to-tray vs direct quit behavior.
- Explicit quit actions in Windows notification area, macOS menu bar, and app settings.
