...
- 底栏歌词按钮直接打开主窗口右侧歌词栏；右栏可独立滚动和点击跳转，不再创建独立桌面歌词窗口。
...
- 原生窗口装饰，默认与最小内容尺寸均为 `960×640`；macOS 菜单栏 / Windows 通知区域提供恢复主窗口、播放/暂停和退出菜单，macOS 点击 Dock 图标也会重新显示隐藏的主窗口。
